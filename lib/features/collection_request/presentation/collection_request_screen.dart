...
class _CollectionRequestScreenState extends ConsumerState<CollectionRequestScreen> {
  ...
  DateTime _date = DateTime(2025, 4, 26);
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          const Text('Paiement sécurisé et instantané', style: TextStyle(fontSize: 12, color: AppColors.textDark)),
