      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          Padding(
            ...
            child: CircleAvatar(backgroundImage: AppAssets.image(AppAssets.avatarPlaceholder)),
          ),
        ],
      ),
      body: ListView(
                  ...
                  : () async {
                      try {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(content: Text('Échange enregistré. Votre solde a été mis à jour.')),
                        );
                      } catch (error) {
                        if (!context.mounted) return;
                        ScaffoldMessenger.of(context).showSnackBar(
