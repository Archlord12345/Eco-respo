...
class WasteReport {
  ...
  /// Référence courte affichée dans l'interface (planche 7 : #SIG-2025-0047).
  String get reference => '#SIG-${id.length > 6 ? id.substring(id.length - 6).toUpperCase() : id.toUpperCase()}';
