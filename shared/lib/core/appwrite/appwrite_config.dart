...
class AppwriteConfig {
  ...
  /// Canal Realtime d'une ligne précise.
  static String rowChannel(String table, String rowId) =>
      Channel.tablesdb(databaseId).table(table).row(rowId).toString();

  /// URL publique de prévisualisation d'un fichier Storage (photos, preuves).
